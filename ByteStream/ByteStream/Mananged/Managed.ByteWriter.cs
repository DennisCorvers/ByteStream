...
#pragma warning restore IDE0032
        ...
        public int Offset
            => m_offset;
        /// <summary>
        /// Determines is this buffer can grow automatically.
        /// </summary>
        ...
        {
            EnsureCapacity(sizeof(ushort) + value.Length);
        ...
        {
            EnsureCapacity(value.Length * sizeof(char) + sizeof(ushort));
            BinaryHelper.WriteValue(m_buffer, m_offset, (ushort)value.Length);
            m_offset += sizeof(ushort);
        ...
        {
            EnsureCapacity(value.Length + sizeof(ushort));
            BinaryHelper.WriteValue(m_buffer, m_offset, (ushort)value.Length);
            m_offset += sizeof(ushort);
